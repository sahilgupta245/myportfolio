        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              <div className="p-4 h-60 border-2 border-[#ffa600] rounded-lg transform transition-all duration-300 hover:scale-105"
              ...
              <div className="p-4 border-2 border-[#ffa600] rounded-lg transform transition-all duration-300 hover:scale-105"
          ...
          <div className="relative group">
            <img
              src={sahil}
              alt="Sahil Gupta"
              className="rounded-2xl border-2 border-[#ffa600] shadow-2xl w-full max-w-xl mx-auto transform transition-all duration-500 group-hover:scale-105"
            />
